class AvailabilityZone < ApplicationRecord
  ...
  def self.available
    where(arel_table[:type].not_eq("ManageIQ::Providers::Openstack::CloudManager::AvailabilityZoneNull"), arel_table[:type].not_eq("ManageIQ::Providers::Telefonica::CloudManager::AvailabilityZoneNull"))
  end
