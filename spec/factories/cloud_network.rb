FactoryGirl.define do
  ...
  factory :cloud_network_public_openstack,
          ...
          :parent => :cloud_network_openstack
  factory :cloud_network_telefonica, :class  => "ManageIQ::Providers::Telefonica::NetworkManager::CloudNetwork",
          :parent => :cloud_network
  factory :cloud_network_private_telefonica,
          :class  => "ManageIQ::Providers::Telefonica::NetworkManager::CloudNetwork::Private",
          :parent => :cloud_network_telefonica
  factory :cloud_network_public_telefonica,
          :class  => "ManageIQ::Providers::Telefonica::NetworkManager::CloudNetwork::Public",
          :parent => :cloud_network_telefonica
